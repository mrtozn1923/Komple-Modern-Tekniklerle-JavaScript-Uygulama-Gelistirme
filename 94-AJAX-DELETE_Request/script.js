...
//DELETE: istenilen veriyi silmek için kullanılır
...
class HTTPRequest{
    ...
    httpDelete(url,callback){
        ...
        this.xhttp.onload=() =>{
            if(this.xhttp.status===200){  
                callback("Silme işlemi tamamlandı");
            }
        }
        this.xhttp.send();
    }
...
//   });
 ...
 request.httpDelete("https://jsonplaceholder.typicode.com/todos/2",function(responseText){
    console.log(responseText);
  });